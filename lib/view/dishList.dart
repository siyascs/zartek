                                  ...
                                  children: [
                                    ListTile(
                                      ...
                                      title: Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          Text(dishesViewModel.dishModel[0].tableMenuList[index].categoryDishes[position].dishName,style: poppinsBoldText()),
                                          const SizedBox(height: 10),
                                          Text("INR ${dishesViewModel.dishModel[0].tableMenuList[index].categoryDishes[position].dishPrice}",style: poppinsMediumText()),
                                          const SizedBox(height: 10),
                                          Text("${dishesViewModel.dishModel[0].tableMenuList[index].categoryDishes[position].dishCalories} Calories",style: poppinsMediumText(),),
                                          const SizedBox(height: 10),
                                          Text(dishesViewModel.dishModel[0].tableMenuList[index].categoryDishes[position].dishDescription,style: poppinsLightText()),
                                          const SizedBox(height: 10),
                                          Container(
                                            height: 35,
                                            width: 100,
                                          ...
                                          const SizedBox(height: 10),
                                          if(dishesViewModel.dishModel[0].tableMenuList[index].categoryDishes[position].addonCat.isNotEmpty) Text(
                                            "Customizations Available",style: poppinsRegularTextRed()
                                          ),
