...
//
//     final categoryDishesModel = categoryDishesModelFromJson(jsonString);

import 'dart:convert';

List<CategoryDishesModel> categoryDishesModelFromJson(String str) => List<CategoryDishesModel>.from(json.decode(str).map((x) => CategoryDishesModel.fromJson(x)));

String categoryDishesModelToJson(List<CategoryDishesModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class CategoryDishesModel {
  ...
  factory CategoryDishesModel.fromJson(Map<String, dynamic> json) => CategoryDishesModel(
